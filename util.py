...
def meta(file, head=True, max_speed=False, columns=None, num_chapters=False):
    df = pd.read_csv(file)
    if head:
...
# print("Train Dataset... ")
# print(" ")
# print(meta(train_path, max_speed=True, columns=["cameraFront", "canSpeed", "chapter"], num_chapters=True))
